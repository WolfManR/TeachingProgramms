...
namespace HomeWork2Console
{
    public class Task6 : HomeWorkTask
    {
        ...
        public override string Title => "Хорошие числа";

        public override int TaskNumber => 6;

        public override string ToDo => "*Написать программу подсчета количества «Хороших» чисел в диапазоне от 1 до 1 000 000 000." +
